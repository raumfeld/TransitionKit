...
/**
 There are multiple destination states possible, with this method you can lookup the events allowed source states by
 providing a destination state.
 
 @return the allowed source states for the given source state or `nil`
 */
